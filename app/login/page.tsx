  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          title: "Welcome Back!",
          description: "Logged in successfully to your dashboard.",
        })
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950 p-4 selection:bg-indigo-500/30">
      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <Link href="/" className="inline-flex items-center text-sm font-medium text-slate-400 hover:text-slate-200 transition-colors mb-6 group">
        ...
        <Card className="bg-slate-900/50 border-slate-800/60 backdrop-blur-2xl shadow-2xl shadow-indigo-500/5 rounded-3xl overflow-hidden relative group">
          ...
          <CardHeader className="space-y-4 pb-6 pt-10 px-8">
            ...
            <div className="space-y-2">
              <CardTitle className="text-3xl font-extrabold text-center text-slate-100 tracking-tight">Welcome Back</CardTitle>
            ...
            <CardContent className="space-y-5 px-8">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="#" className="text-sm font-medium text-indigo-400 hover:text-indigo-300 hover:underline transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <Input
